...
Import the components a page uses, or register the full set with
`import 'compost/components'`.

- [compost-audio](components/compost-audio.md)
- [compost-midi](components/compost-midi.md)
- [compost-device-selector](components/compost-device-selector.md)
...
- [compost-channel-strip](components/compost-channel-strip.md)

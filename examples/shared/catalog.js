...
export const examples = [
  { id: 'signal-generator', href: './signal-generator/', title: 'Signal Generator', summary: 'Integrated AudioWorklet synth with live scope and meter, shared parameter controls, a MIDI drawer, and real MIDI mapping.', components: ['compost-audio', 'compost-button', 'compost-drawer', 'compost-knob', 'compost-meter', 'compost-midi', 'compost-midi-mappings', 'compost-midi-monitor', 'compost-number-box', 'compost-piano', 'compost-scope', 'compost-select', 'compost-slider'], utilities: ['ParameterController', 'MIDIMappings'], runtime: 'JavaScript AudioWorklet.' },

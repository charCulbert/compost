...
export function normaliseParameterScale(options?: ParameterScaleOptions): NormalisedParameterScale;

/** Maps a 0..1 position onto the parameter's value range. */
export function normalisedPositionToValue(position: number, options?: ParameterScaleOptions): number;

/** Maps a value onto its 0..1 position along the scale. */
export function valueToNormalisedPosition(value: number, options?: ParameterScaleOptions): number;

/** Moves a value by a delta expressed in normalised position. */
export function moveValueByNormalisedDelta(value: number, delta: number, options?: ParameterScaleOptions): number;

/** The 0..1 step a keyboard arrow moves, from a position or value step. */
export function normalisedKeyboardStep(options?: ParameterScaleOptions & {positionStep?: number | string | null, step?: number | string | null}): number;
...
export function parameterScaleBreakpoints(options?: ParameterScaleOptions): number[];

  ...
  constructor() {
    ...
    this.root.innerHTML = `
      <style>
        ...
        .automation-editor { width: 100%; height: 100%; min-height: 0; border: 0; overflow: visible; --compost-envelope-bg: transparent; --compost-envelope-line: transparent; --compost-envelope-signal: var(--lane-color, var(--compost-timeline-text)); --compost-envelope-point-bg: var(--compost-envelope-signal); --compost-envelope-point-border: var(--compost-timeline-bg); --compost-envelope-preview: var(--compost-timeline-over); --compost-envelope-selection: transparent; --compost-envelope-grid-size: 100000px; }
        .automation-editor::part(selection) { border-inline: 0; }

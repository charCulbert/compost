...
export function adaptiveGridStep(
	...
	const steps = [...new Set([bar, 4, 2, 1, 0.5, 0.25, 0.125, 0.0625])]
...
export function gridStepForView(
	beatsPerBar,
	grid,
	pxPerBeat,
	adaptive = false,
...
export function snapTime(
	...
	for (const anchor of anchors) {
		...
		if (Number.isFinite(time) && Math.abs(time - raw) <= reach)

...
export function normaliseDeviceSelectorSnapshot(snapshot = {}) {
  ...
  return {
    ...
    audio: {
      ...
      sampleRate,
      bufferSize,
      sampleRates: uniquePositiveIntegers([sampleRate, ...(audio.sampleRates || [])]),
      bufferSizes: uniquePositiveIntegers([bufferSize, ...(audio.bufferSizes || [])]),
      requiredInputChannels: nonNegativeIntegerOrNull(audio.requiredInputChannels),
      requiredOutputChannels: nonNegativeIntegerOrNull(audio.requiredOutputChannels),
    },
    midi: {
...
export function deviceSettingsDetailFromSnapshot(snapshot = {}, overrides = {}) {
